...
public class Controller {
	...
	/**
	 * get Departments in the client.
	 * 
	 * @return list of string
	 */
	@GetMapping("/client/getDepartments/")
	public List<String> getDepartments() {
		return clientService.getDepartments();
	}
	...
	public ResponseEntity<Client> updateClientProfile(@RequestBody Client client) {
		try {
			if (client == null || client.getEmail() == null || client.getEmail().isEmpty()) {
				return ResponseEntity.badRequest().build();
			}

			Client updatedClient = clientService.updateClientProfile(client);
	 ...
	 */
	@GetMapping("/getDoctorList/{department}")
	public List<Doctor> getDoctorList(@PathVariable String department) {
